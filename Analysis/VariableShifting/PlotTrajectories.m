...
loadnew=0;
starttraj=1; 
endtraj=5000; %use 0 to default to final trajectory
minpercentvalid=0.5; 
minlength=15; %only plot trajectories longer than min
...
trajcolor='displacement'; %possible modes are 'displacement', 'logdisp', 'time', and 'none'
...
%-- other misc settings
highdis=2.5;  %maximum expected displacement in pixels, used for setting coloring and setting the space between trajectories for tiled mode
